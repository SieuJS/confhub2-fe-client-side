...
import { fetchConferences, FetchConferencesParams } from '../../app/apis/conference/getFilteredConferences'; // Import
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const params: FetchConferencesParams = {
        ...
        subFromDate: searchParams.get('subFromDate') || undefined,
        subToDate: searchParams.get('subToDate') || undefined,

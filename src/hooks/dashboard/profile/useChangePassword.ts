...
const API_VERIFY_PASSWORD_ENDPOINT = 'http://localhost:3000/api/v1/user/verify-password';
const API_CHANGE_PASSWORD_ENDPOINT = 'http://localhost:3000/api/v1/user/change-password';

...
describe('MobileNavigation Component', () => {
  ...
  // Add back the click test if needed
  // it('should call closeAllMenus when a link is clicked', async () => {
  //   const user = userEvent.setup(); // Make sure user-event is installed and setup
  //   renderWithIntl(<MobileNavigation {...defaultProps} isMobileMenuOpen={true} data-testid={testId} />)
  //   const confLink = screen.getByRole('link', { name: mockMessages.Conferences })
  //   await user.click(confLink)
  //   expect(defaultProps.closeAllMenus).toHaveBeenCalledTimes(1)
  // })
})

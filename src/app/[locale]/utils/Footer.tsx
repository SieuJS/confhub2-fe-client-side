...
type FooterLink = {
  ...
  href:
    | AppPathname
    | { pathname: AppPathname; query: Record<string, string | number> }
}
...
const Footer = () => {
  ...
  const popularTopics = [
    {
      href: { pathname: '/conferences', query: { topics: 'Business' } },
      label: t('Business')
    },
    {
      href: {
        pathname: '/conferences',
        query: { topics: 'Banking and Economics' }
      },
      label: t('Banking_and_Economics')
    },
    {
      href: { pathname: '/conferences', query: { topics: 'Engineering' } },
      label: t('Engineering')
    },
    {
      href: { pathname: '/conferences', query: { topics: 'Education' } },
      label: t('Education')
    },
    {
      href: { pathname: '/conferences', query: { topics: 'Health' } },
      label: t('Health')
    }
  ] as FooterLink[]
  ...
  const popularCountries = [
    {
      href: { pathname: '/conferences', query: { country: 'Australia' } },
      label: t('Australia')
    },
    {
      href: { pathname: '/conferences', query: { country: 'Germany' } },
      label: t('Germany')
    },
    {
      href: { pathname: '/conferences', query: { country: 'India' } },
      label: t('India')
    },
    {
      href: { pathname: '/conferences', query: { country: 'United States' } },
      label: t('United_States')
    },
    {
      href: { pathname: '/conferences', query: { country: 'United Kingdom' } },
      label: t('United_Kingdom')
    }
  ] as FooterLink[]
  ...
  const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/school/vnuhcm---university-of-science/',
      label: 'LinkedIn',
      icon: LinkedinIcon
    },
    {
      href: 'https://www.tiktok.com/@tvts.hcmus',
      label: 'TikTok',
      icon: TiktokIcon
    }
  ]
  ...
  return (
    <footer className='w-full bg-gradient-to-r from-background to-background-secondary '>
      <div className='container mx-auto max-w-screen-2xl px-12 py-16'>
          ...
          <>
            ...
            <div className='grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-12'>
              <div className='md:col-span-4'>
                ...
                <p className='text-md mt-4 '>{t('Footer_Description')}</p>
              </div>
              <div className='md:col-span-8'>
                <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3'>
                  ...
                  />
                  <FooterLinkColumn
                    title={t('Popular_countries')}
                    links={popularCountries}
                    icon={GlobeAltIcon}
                  />
                </div>
              </div>
              ...
              <div className='mt-16 rounded-lg bg-slate-400 p-8'>
                <div className='grid items-center gap-8 md:grid-cols-2'>
                  <div>
                    ...
                    <p className='mt-2 '>{t('Newsletter_Subtitle')}</p>
                  </div>
                  <form
                    className='mt-4 flex w-full md:mt-0'
                  ...
                  >
                    ...
                    <button
                      type='submit'
                      className='flex-shrink-0 rounded-r-md bg-indigo-400 px-6 py-3 font-semibold  transition-colors hover:bg-indigo-700'
                    >
        ...
        <div
          className={`${bottomBarMarginTopClass} flex flex-col items-center border-t border-slate-700 pt-8`}
        >

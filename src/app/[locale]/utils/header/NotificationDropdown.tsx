...
const NotificationDropdown: FC<Props> = ({ notifications, isNotificationOpen, closeAllMenus, locale }) => {
  return (
    <div
    ...
    >
      <div className='py-2'>
        {notifications.length > 0 ? (
          ...
          <div className='text-foreground px-4 py-2 text-sm'>No new notifications</div>
        )}

...
const NotificationDropdown: FC<Props> = ({
      ...
      >
        ...
        >
          ...
          <div className='flex-grow'>
            <p
              className={`text-sm ${notification.seenAt ? 'text-gray-700' : 'font-bold'}`}
            >
  ...
  return (
    <div
      className={`absolute right-0 z-50 mr-8 mt-10 w-80 overflow-hidden rounded-lg bg-white shadow-xl transition-all duration-300 ease-in-out ${
        isNotificationOpen

      ...
      <div className='relative flex flex-col items-start gap-5 px-6 py-5 md:flex-row md:items-center'>
        ...
        <div className='flex-grow'>
          <h1 className='text-3xl font-bold '>
            ...
            {/* {userData.role === 'admin' && (
              <FaCheckCircle className='ml-2 inline-block text-button' />
            )} */}
          </h1>
          ...
          <div className='space-y-6 py-2'>
            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
              <div>
                ...
                <input
                  ...
                  className='mt-2 block w-full rounded-md border-background p-2 shadow-sm focus:border-button focus:ring-button focus:ring-opacity-50'
                />
              </div>
              <div>
                <label
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className='mt-2 block h-32 w-full rounded-md border-background p-2 shadow-sm focus:border-button focus:ring-button focus:ring-opacity-50'
              />
            </div>
            <div className='mt-4'>
              <label
            ...
            <div className='mt-4'>
              <label className='block text-sm font-medium '>
                I am also interested in these sectors
              </label>
              <div className='mt-2 flex flex-wrap gap-2'>
                <span className='rounded-full bg-background px-4 py-2 text-sm transition duration-200 hover:bg-gray-200'>
                  Apparel & Clothing
                </span>
                <span className='rounded-full bg-background px-4 py-2 text-sm transition duration-200 hover:bg-gray-200'>
                  Home & Office
            ...
            <div className='mt-8 flex justify-end space-x-4'>
              <button
                ...
                className='rounded-md bg-gray-200 px-6 py-2  transition duration-200 ease-in-out hover:bg-background focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50'
              >
                Cancel
              </button>
              <button
                ...
                className='rounded-md bg-blue-600 px-6 py-2 text-white transition duration-200 ease-in-out hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-button focus:ring-opacity-50'
              >
                Save
              </button>
            </div>

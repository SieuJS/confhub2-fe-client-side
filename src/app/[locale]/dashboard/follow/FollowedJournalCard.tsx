        ...
        <div className='mt-2 space-y-2 text-sm text-gray-60'>
          {journal.ISSN && (
             <div className='flex items-center gap-2'>
              <BookOpen className='h-4 w-4 flex-shrink-0 text-gray-40' />
              <span>{journal.ISSN}</span>
            </div>
          )}
          {journal.Publisher && (
            <div className='flex items-center gap-2'>
              <Building className='h-4 w-4 flex-shrink-0 text-gray-40' />
              <span className='line-clamp-1'>{journal.Publisher}</span>
            </div>
          )}
          {journal.Country && (
            <div className='flex items-center gap-2'>
              <Globe className='h-4 w-4 flex-shrink-0 text-gray-40' />

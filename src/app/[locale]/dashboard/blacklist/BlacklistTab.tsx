...
const BlacklistTab: React.FC<BlacklistTabProps> = () => {
  ...
  const filteredConferences = useMemo(() => {
    ...
    return blacklistedConferences.filter(conference =>
  ...
  return (
    <div className='container mx-auto p-4 md:p-6 bg-gray-10 min-h-screen'>
      ...
      {blacklistedConferences.length > 0 && (
        <div className="mb-6">
          <SearchInput
            ...
            placeholder={t('Search_blacklisted_conferences') || 'Search by title or acronym...'}
          />
        </div>
      )}
      ...
      {!loading && blacklistedConferences.length > 0 && filteredConferences.length === 0 && (
        <div className="my-10 text-center text-gray-500 bg-white p-10 rounded-lg shadow-sm">

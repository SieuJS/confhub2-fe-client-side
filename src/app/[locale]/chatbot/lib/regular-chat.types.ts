...
export interface SendMessageData {
  ...
  personalizationData?: CombinedSettingsPayload | null;
...
export interface UserProfileData { // Renamed for clarity
...
export interface CombinedSettingsPayload { // Renamed for clarity
  isPersonalizationEnabled: boolean; // Should personalization profile data be used?
  userProfile?: UserProfileData;     // The actual profile data
  isGoogleSearchEnabled: boolean;   // Should Google Search be used?
}

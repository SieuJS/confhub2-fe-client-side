...
const LeftPanel: React.FC<LeftPanelProps> = ({
  ...
  return (
    <div
      className={`h-full flex-shrink-0 overflow-y-hidden bg-white text-gray-800 shadow-xl transition-all duration-300 ease-in-out ${
    ...
    >
      <div className='flex h-full min-w-[18rem] flex-col overflow-hidden'>
        {/* Header */}
        <div className='flex flex-shrink-0 items-center justify-between border-b border-gray-200 p-5 pb-4'>
        ...
        {/* Chat Mode Selector */}
        <div className='flex-shrink-0 border-b border-gray-100 p-5 pb-3'>
          <ChatModeSelector

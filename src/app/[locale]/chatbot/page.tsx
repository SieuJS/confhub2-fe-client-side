...
const ChatBotPage: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white h-screen flex flex-col justify-center items-center overflow-hidden relative">
      {/* Background Design (No changes here) */}
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            className="border border-white hover:border-gray-300 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex items-center">

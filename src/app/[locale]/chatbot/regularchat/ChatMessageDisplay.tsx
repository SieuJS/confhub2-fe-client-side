                    ...
                    <ReactMarkdown
                        ...
                        components={{
                            ...
                            pre: ({ node: _, ...props }: MarkdownComponentProps<'pre'>) => (
                                <pre
                                    className='overflow-x-auto rounded-md bg-gray-100 dark:bg-gray-800 p-2 my-2 text-gray-800 dark:text-gray-200' // Adjusted pre style
                                    {...props}
                                />
                            ),
                            code: ({ node: _, ...props }: MarkdownComponentProps<'code'>) => (
                                <code className='rounded bg-gray-200 dark:bg-gray-600 px-1 py-0.5 text-red-600 dark:text-red-400 font-mono text-xs' {...props} /> // Adjusted code style
                            ),

...
const findInfoIntroductions: IntroductionType = {
  ...
  content: {
    en: {
      greeting: 'Hello',
      description:
        "I'm here to help you find conference information. Try this suggestion:",
      suggestions: [
        'List some AI conferences in Asia.',
        'Find Big Data conferences this year (2025).',
        'I want to know about blockchain conferences in Europe.'
    ...
    vi: {
      greeting: 'Xin chào',
      description:
        'Tôi có thể giúp bạn tìm thông tin về các hội nghị. Hãy thử gợi ý này:',
      suggestions: [
        'Liệt kê cho tôi một vài hội nghị về lĩnh vực AI tổ chức tại châu Á.',
        'Tìm các hội nghị về Big Data trong năm nay (2025).',
        'Tôi muốn biết về các hội nghị blockchain tại châu Âu.'
    ...
    de: {
      ...
      greeting: 'Hallo',
      description:
        'Ich helfe Ihnen gerne bei der Suche nach Konferenzinformationen. Versuchen Sie diesen Vorschlag:',
      suggestions: [
        'Listen Sie einige KI-Konferenzen in Asien auf.',
        'Finden Sie Big Data Konferenzen dieses Jahr (2025).',
        'Ich möchte mehr über Blockchain-Konferenzen in Europa erfahren.'
    ...
    es: {
      ...
      greeting: 'Hola',
      description:
        'Estoy aquí para ayudarte a encontrar información de conferencias. Prueba esta sugerencia:',
      suggestions: [
        'Listar algunas conferencias de IA en Asia.',
        'Encontrar conferencias de Big Data este año (2025).',
        'Quiero saber sobre conferencias de blockchain en Europa.'
    ...
    ko: {
      ...
      greeting: '안녕하세요',
      description:
        '컨퍼런스 정보를 찾는 것을 도와드릴 수 있습니다. 다음 제안을 시도해보세요:',
      suggestions: [
        '아시아의 AI 컨퍼런스를 몇 개 나열해주세요.',
        '올해(2025년)의 빅데이터 컨퍼런스를 찾아주세요.',
        '유럽의 블록체인 컨퍼런스에 대해 알고 싶습니다.'
    ...
    ru: {
      ...
      greeting: 'Здравствуйте',
      description:
        'Я здесь, чтобы помочь вам найти информацию о конференциях. Попробуйте это предложение:',
      suggestions: [
        'Перечислите несколько конференций по ИИ в Азии.',
        'Найдите конференции по большим данным в этом году (2025).',
        'Я хочу узнать о конференциях по блокчейну в Европе.'
    ...
    ar: {
      ...
      greeting: 'مرحباً',
      description:
        'أنا هنا لمساعدتك في العثور على معلومات المؤتمرات. جرب هذا الاقتراح:',
      suggestions: [
        'اذكر بعض مؤتمرات الذكاء الاصطناعي في آسيا.',
        'ابحث عن مؤتمرات البيانات الكبيرة هذا العام (2025).',
        'أريد أن أعرف عن مؤتمرات البلوك تشين في أوروبا.'
    ...
    fr: {
      ...
      greeting: 'Bonjour',
      description:
        'Je suis là pour vous aider à trouver des informations sur les conférences. Essayez cette suggestion :',
      suggestions: [
        "Liste quelques conférences sur l'IA en Asie.",
        'Trouve des conférences sur les Big Data cette année (2025).',
        'Je veux en savoir plus sur les conférences blockchain en Europe.'
    ...
    ja: {
      ...
      greeting: 'こんにちは',
      description:
        '会議情報を見つけるお手伝いをします。この提案を試してみてください:',
      suggestions: [
        'アジアのAIに関する会議をいくつかリストアップしてください。',
        '今年のビッグデータに関する会議を探してください (2025)。',
        'ヨーロッパのブロックチェーンに関する会議について知りたいです。'
...
const redirectToWebsiteIntroductions: IntroductionType = {
  ...
  content: {
    ...
    de: {
      ...
      greeting: 'Hallo',
      description:
        'Müssen Sie eine Konferenz-Website besuchen? Fragen Sie mich!',
      suggestions: [
    ...
    es: {
      ...
      greeting: 'Hola',
      description:
        '¿Necesitas visitar el sitio web de una conferencia? ¡Pregúntame!',
      suggestions: [
    ...
    fr: {
      ...
      greeting: 'Bonjour',
      description:
        "Besoin de visiter le site web d'une conférence ? Demandez-moi !",
      suggestions: [
...
const openMapIntroductions: IntroductionType = {
  ...
  content: {
    ...
    de: {
      ...
      greeting: 'Hallo',
      description:
        'Möchten Sie den Standort einer Konferenz finden? Ich kann helfen!',
      suggestions: [
    ...
    es: {
      ...
      greeting: 'Hola',
      description:
        '¿Quieres encontrar la ubicación de una conferencia? ¡Puedo ayudarte!',
      suggestions: [
    ...
    fr: {
      ...
      greeting: 'Bonjour',
      description:
        "Vous voulez trouver l'emplacement d'une conférence ? Je peux vous aider !",
      suggestions: [
...
const learnWebsiteIntroductions: IntroductionType = {
  ...
  content: {
    ...
    de: {
      ...
      greeting: 'Hallo',
      description:
        'Möchten Sie mehr über diese Website erfahren? Fragen Sie mich!',
      suggestions: [
    ...
    fr: {
      ...
      greeting: 'Bonjour',
      description:
        'Vous voulez en savoir plus sur ce site web ? Demandez-moi !',
      suggestions: [
    ...
    ja: {
      ...
      greeting: 'こんにちは',
      description:
        'このウェブサイトについてもっと知りたいですか？聞いてください！',
      suggestions: [
...
const selectRandomIntroductionsWithOneSuggestion = (
  language: Language
): {
  type: string
  greeting: string
  ...
  return selectedTypes.map(introType => {
    ...
    const randomSuggestion =
      content.suggestions.length > 0
        ? content.suggestions[
            Math.floor(Math.random() * content.suggestions.length)
          ]
...
const ChatIntroductionDisplay: React.FC<ChatIntroductionProps> = ({
  ...
  const [displayedIntroductions, setDisplayedIntroductions] = useState<
    {
      type: string
      greeting: string
      description: string
  ...
  useEffect(() => {
    ...
    setDisplayedIntroductions(
      selectRandomIntroductionsWithOneSuggestion(language)
    )
  }, [language]) // Re-run when language changes

  // We now get the greeting from the first displayed introduction or the default
  const greeting =
    displayedIntroductions.length > 0
      ? displayedIntroductions[0].greeting
      : defaultIntroductions[language]?.greeting ||
        defaultIntroductions.en.greeting
          ...
          <div key={index} className='mb-4 last:mb-0'>
            ...
            <div className='flex flex-wrap justify-center gap-1.5 sm:gap-2'>
              ...
              <button
                ...
                className='dark:hover:0 rounded-2xl border border-gray-300 bg-white-pure px-2.5 py-1 text-xs font-medium  transition-colors duration-150 hover:border-gray-40 hover:bg-gray-10 focus:outline-none focus:ring-2 focus:ring-blue-300   sm:px-3 sm:text-sm'
              >
                {intro.suggestion}
              </button>
            </div>

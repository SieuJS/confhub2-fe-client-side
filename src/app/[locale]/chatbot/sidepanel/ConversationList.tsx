            ...
            return (
              <div key={conv.id} className='group relative'>
                ...
                >
                  ...
                  <div
                    className={`text-xs ${conv.id === activeConversationId ? 'text-blue-600' : ''}`}
                  >
                ...
                <div className='absolute right-0 top-0 flex h-full items-center space-x-1 pr-2 opacity-0 transition-opacity duration-150 focus-within:opacity-100 group-hover:opacity-100'>
                  ...
                  <button
                    ...
                    className='rounded-md p-1.5  hover:bg-yellow-100 hover:text-yellow-600 focus:outline-none focus:ring-1 focus:ring-yellow-500 disabled:cursor-not-allowed disabled:opacity-50'
                  ...
                  <button
                    ...
                    className='rounded-md p-1.5  hover:bg-red-100 hover:text-red-600 focus:outline-none focus:ring-1 focus:ring-red-500 disabled:cursor-not-allowed disabled:opacity-50'

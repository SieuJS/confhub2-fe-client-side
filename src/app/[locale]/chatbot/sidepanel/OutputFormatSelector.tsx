    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                >
                    <Text stroke="currentColor" className={`mb-1 h-6 w-6 ${isTextSelected ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500'}`} aria-hidden="true" size={24} />
                    <span className={`text-sm font-medium ${isTextSelected ? 'text-blue-700' : 'text-gray-700 group-hover:text-gray-800'}`}> Text </span>
                </button>
            </div>
        </div>
    );

...
const FAQ = ({ locale }: { locale: string }) => {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-background to-background-secondary w-full p-14"> {/* Added padding */}

        <div className="relative container grid grid-cols-1 md:grid-cols-5 gap-4 items-center"> 

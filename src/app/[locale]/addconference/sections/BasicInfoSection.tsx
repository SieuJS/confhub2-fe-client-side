...
const BasicInfoSection: React.FC<BasicInfoSectionProps> = ({
    ...
    const ExistenceStatusIndicator = () => {
        ...
        if (existenceCheck.status === 'success') {
            ...
            return (
                <span title={existenceCheck.message || t('This_combination_is_available')}>
    ...
    return (
        <div id={id}>
            ...
            >
                ...
                <div className="sm:col-span-6 grid grid-cols-12 gap-x-4 items-start">
                    ...
                    <div className="col-span-1 pt-9"> {/* Căn chỉnh indicator với input */}
                ...
                <div className="sm:col-span-6 grid grid-cols-12 gap-x-4 items-start">
                    <div className="col-span-11">
                        <TextInput
                            ...
                            onChange={e => handlers.handleFieldChange('acronym', e.target.value)}

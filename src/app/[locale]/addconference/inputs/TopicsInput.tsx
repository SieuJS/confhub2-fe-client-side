  ...
  return (
    <div className='sm:col-span-6'>
      <div className='mb-1 flex items-center gap-2'>
        <label htmlFor='newTopic' className='block text-sm font-medium '>
      ...
      <div className='flex flex-col gap-2 sm:flex-row sm:items-start sm:gap-3'>
        <div className='flex-grow'>
          <input
            ...
            className={clsx(
              'w-full rounded-md p-2 shadow-sm sm:text-sm',
      ...
      {showRequiredError && (
        <p id='topics-required-error' className='mt-2 text-sm text-red-600'>
          {t('Please_add_at_least_one_topic')}
        </p>
      )}
    </div>
  )

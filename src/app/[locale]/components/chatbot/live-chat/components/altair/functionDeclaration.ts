...
export const yourResponseDeclaration: FunctionDeclaration = {
  name: "yourResponse",
  description: "Provides the final answer to the user, based on the results from other functions and the original question.",
  parameters: {
    type: SchemaType.OBJECT,
    properties: {
      finalResponse: {
        type: SchemaType.STRING,
        description: "The final answer that you will provide to the user.",
      },
    },
...
3. ALWAYS use the 'yourResponse' function to prepare your final response to the user, based on the results from the other functions and the original question.
